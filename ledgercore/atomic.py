    ...
    try:
        ...
        if tmp_path is not None:
            try:
                ...
                pass
        raise AtomicWriteError(f"Atomic write failed for {path}") from None
...
def atomic_create_text(
    ...
    *,
    ...
    if path.exists():
        raise AtomicWriteError(f"Target already exists: {path}")
    ...
    try:
        ...
        if tmp_path is not None:
            try:
                ...
                pass
        raise AtomicWriteError(f"Atomic create failed for {path}") from None
